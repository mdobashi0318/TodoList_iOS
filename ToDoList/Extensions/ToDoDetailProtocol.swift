...
extension ToDoDetailProtocol {
    ...
    private func setAttributes(_ label: UILabel) {
        ...
        attrText.addAttributes(attributes, range: NSRange(location: label.text!.count - 3, length: 3))
    ...
    private func setExpiredAttributes(_ label: UILabel) {
        ...
        attrText.addAttributes(attributes,
                               range: NSRange(location: label.text!.count - R.string.message.expiredText().count, length: R.string.message.expiredText().count))
        label.attributedText = attrText
    }
