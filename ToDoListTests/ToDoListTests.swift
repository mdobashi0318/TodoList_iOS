...
//        ToDoModel.addToDo(view, addValue: ToDoModel(id: "0", toDoName: "UnitTest", todoDate: addTodoDate, toDo: "詳細", createTime: nil))
//        let todoModel = ToDoModel.findToDo(view, todoId: "0", createTime: nil)
//        
...
//        ToDoModel.updateToDo(view, todoId: "0", updateValue: ToDoModel(id: "0", toDoName: "EditUnitTest", todoDate: updateTodoDate, toDo: "詳細編集", createTime: nil))
//        
//        
//        let todoModel = ToDoModel.findToDo(view, todoId: "0", createTime: nil)
//        XCTAssert(todoModel?.id == "0", "idが登録されていない")
...
//        let todoModel = ToDoModel.findToDo(view, todoId: "0", createTime: nil)
//        
//        XCTAssertTrue(ToDoModel.allFindToDo(view)!.count > 0, "Todoが作成されていない")
//        XCTAssert(todoModel?.id == "0", "idが登録されていない")
//        XCTAssert(todoModel?.toDoName == "UnitTest", "Todoのタイトルが登録されていない")
//        XCTAssert(todoModel?.todoDate == addTodoDate, "　Todoの期限が登録されていない")
//        XCTAssert(todoModel?.toDo == "詳細", "　Todoの詳細が登録されていない")
//        XCTAssert(!(todoModel?.createTime!.isEmpty)!, "Todo作成時間が登録されていない")
//        
//        ToDoModel.deleteToDo(view, todoId: todoModel!.id, createTime: todoModel?.createTime) {
//            XCTAssertFalse(ToDoModel.allFindToDo(view)!.count > 0, "Todoが削除されていない")
//        }
//        
//    }
//    
...
//        let addTodoDate = Format().stringFromDate(date: Date())
//        ToDoModel.addToDo(view, addValue: ToDoModel(id: "0", toDoName: "UnitTest1", todoDate: addTodoDate, toDo: "詳細1", createTime: nil))
//        sleep(1)
//        ToDoModel.addToDo(view, addValue: ToDoModel(id: "1", toDoName: "UnitTest2", todoDate: addTodoDate, toDo: "詳細2", createTime: nil))
//        
//        let todoModel1 = ToDoModel.findToDo(view, todoId: "0", createTime: nil)
//        
//        XCTAssertTrue(ToDoModel.allFindToDo(view)!.count == 2, "Todoが作成されていない")
...
//        
//        let todoModel2 = ToDoModel.findToDo(view, todoId: "1", createTime: nil)
...
//        
//        ToDoModel.allDeleteToDo(view) {
//            XCTAssertFalse(ToDoModel.allFindToDo(self.view)!.count > 0, "Todoが削除されていない")
//        }
//        
//    }
//    
