...
class NotificationManagerTests: XCTestCase {
    ...
    func test_addNotification() {
        ...
        NotificationManager().addNotification(toDoModel: ToDoModel(id: "0", toDoName: "TEST", todoDate: Format().stringFromDate(date: Date(timeIntervalSinceNow: 60 * 60 * 48)), toDo: "TESTTodo", createTime: createTime1)) { result in
            XCTAssertTrue(result, "Todoの登録に失敗している")
        }
        
        
        NotificationManager().addNotification(toDoModel: ToDoModel(id: "0", toDoName: "TEST", todoDate: "TESTDate", toDo: "TESTTodo", createTime: Format().stringFromDate(date: Date(), addSec: true))) { result in
    ...
    func test_deleteNotification() {
        ...
        let todoModel1 = ToDoModel(id: "0", toDoName: "TEST", todoDate: todoDate1, toDo: "TESTTodo", createTime: createTime1)
        ...
        let todoModel2 = ToDoModel(id: "0", toDoName: "TEST", todoDate: todoDate2, toDo: "TESTTodo", createTime: createTime2)
